    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center relative overflow-hidden font-sans pt-12 pb-12">
      ...
      <div className="bg-white p-8 md:p-10 rounded-[2rem] shadow-xl w-full max-w-[420px] z-10 border border-slate-100 relative overflow-hidden">
        ...
        <div className="flex gap-4">
          <Button type="button" onClick={() => console.log("Google auth temporarily disabled")} variant="outline" className="w-full h-11 text-slate-600 font-bold border-slate-200 rounded-xl hover:bg-slate-50">
          ...
          <Button type="button" onClick={() => console.log("GitHub auth temporarily disabled")} variant="outline" className="w-full h-11 text-slate-600 font-bold border-slate-200 rounded-xl hover:bg-slate-50">
